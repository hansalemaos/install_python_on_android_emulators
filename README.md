...
```sh
adb.exe -s 127.0.0.1:7555 install -g -t "%USERPROFILE%\Downloads\magisk_kitsune.apk"
...
```sh
adb.exe -s 127.0.0.1:7555 install -g -t "%USERPROFILE%\Downloads\termux-app_v0.118.1+github-debug_x86_64.apk"
```
...
```sh
adb.exe -s 127.0.0.1:7555 install -g -t "%USERPROFILE%\Downloads\termux-boot-app_v0.8.1+github.debug.apk"
```
...
```sh
adb.exe -s 127.0.0.1:7555 push "%USERPROFILE%\Downloads\termuxtoadb.zip" /sdcard
adb.exe -s 127.0.0.1:7555 push "%USERPROFILE%\Downloads\make.writeable.zip" /sdcard
...
[![Video 1](https://img.youtube.com/vi/KMPGV4d0q08/0.jpg)](https://www.youtube.com/watch?v=KMPGV4d0q08)


### [Download BlissOS 16 Go](https://sourceforge.net/projects/blissos-x86/files/Official/BlissOS16/Gapps/Go/)
